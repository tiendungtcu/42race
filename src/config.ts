...
export class Config {
    debugLogging = 'debug';
    'server.port' = '7799';
    'jhipster.clientApp.name' = '42race';
    ...
    'jhipster.mail.from' = '42race@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = '42race API';
    'jhipster.swagger.description' = '42race API documentation';
    ...
    'eureka.instance.appname' = '42race';
    'eureka.instance.instanceId' = '42race:${random.value}';
